...
<p>
    <a href="https://central.sonatype.com/artifact/io.valkyrja/spotless"><img src="https://img.shields.io/maven-central/v/io.valkyrja/spotless?label=Maven%20Central" alt="Latest Stable Version"></a>
...
buildscript {
    ...
    dependencies {
        classpath("io.valkyrja:spotless:26.1.0")
    }
}
